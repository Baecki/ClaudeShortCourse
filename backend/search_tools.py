...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            # Build label and look up lesson link (deduplicate by label)
            label = course_title
            if lesson_num is not None:
...
class CourseOutlineTool(Tool):
    """Tool for retrieving a structured course outline (title, link, lessons)"""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the full outline of a course: title, link, and all lessons with numbers and titles",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_title": {
